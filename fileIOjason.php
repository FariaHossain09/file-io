...
if(!$flag) {
$arr1[] = array("fname" => $fname, "lname" => $lname, "gender" =>$gender,"birthday"=>$birthday,"re"=>$re,"paddress"=>$paddress,"ppaddress"=>$ppaddress,"phone"=>$phone,"email"=>$email,"username"=>$username,"password"=>$password);
